...
class _Competition_nameState extends State<Competition_name> {
  ...
  Future get_competition_location_data() async {
    final response = await http.get(
        "http://hpsport.in/api/v3/get_competitions.php?tag=fetchcompetitions&SportsID=2&qLimit=50&qOffset=0&LoggedinUserID=1&q=inter");
          ...
          Container(
            ...
            child: AutoCompleteTextField(
              ...
              itemSubmitted: (value) {
                ...
                Form_screen.selectedName=value;
              },
